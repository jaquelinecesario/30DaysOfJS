...
How to declare a function and how to call a function.
...
Function can also return values, if a function does not return values the value of the function is undefined. From now on, we return value to a function instead of printing it.
